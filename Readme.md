...
express.Router() is a built-in middleware in Express.js that is used to create modular, mountable route handlers. It enables you to define routes in a more organized and manageable way, particularly when your application grows larger.
...
process.env is a global object in Node.js that provides access to environment variables. .PORT attempt to
retrieve the port number from the environment variable and if it could not, will choose the port number 
8081. 
---
